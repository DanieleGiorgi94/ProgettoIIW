...
void exit_command_handler(int sockfd, int fin, char *no_connections,
    ...
    while (recvfrom(sockfd, (void *) req, sizeof(request_t), MSG_DONTWAIT,
        ...
        //spesso rimane bloccato in questa recvfrom perché probabilmente il
        //client invia l'ACK prima che venga eseguita questa istruzione quindi
        //dopo un po' chiudiamo e basta
